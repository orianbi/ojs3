...
<div class="obj_article_summary">
	...
	<img src="http://localhost/ojs3/templates/images/grafik.png"> {translate key="article.abstract"} View: {$article->getViews()}, <img src="http://localhost/ojs3/templates/images/pdfdownload.png"> {$galley->getGalleyLabel()} Download: {$galley->getViews()}
